		...
		<div class="popupWrap">
			...
			<form @submit.prevent="save">
				<table class="popT">
					...
					<tr><th class="th">게시판분류번호</th><td class="td"><input type="number" v-model="props.data.brdCatNo" /></td></tr>
...
const saveInfo = () => { // 정보저장
	...
	((!props.data.brdNo) ? BoardService.insertBoard : BoardService.updateBoard)(formData).then(
		(res) => {
			if(res.success) {
				location.reload();
			} else {
