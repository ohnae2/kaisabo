...
onMounted(() => {
	data.grid = new Grid({
		...
		rowHeaders: ['checkbox'],
		columns: [
			{header: '게시판댓글번호', name: 'brdCmmtNo', sortable: true, width: 100, disabled: false, editor: 'text'}, // 게시판댓글번호
			{header: '게시판번호', name: 'brdNo', sortable: true, width: 100, disabled: false, editor: 'text'}, // 게시판번호
