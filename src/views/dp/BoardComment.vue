...
const data = reactive({
	grid: {} as Grid,
	required: ['brdNo', 'cmpId', 'cnts', 'linkRef', 'modId', 'modDt', 'regId', 'regDt'],
	totalCount: 0,
	list: [],
	audit: false,
});
...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: '게시판댓글번호', name: 'brdCmmtNo', sortable: true, width: 100, align: 'right', disabled: false, validation: { dataType: 'number' , required: false }, editor: 'text'}, // 게시판댓글번호
