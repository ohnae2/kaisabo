...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: '전시번호', name: 'dispNo', sortable: true, width: 100, align: 'right', disabled: false, editor: 'text'}, // 전시번호
			...
			{header: '전시코드', name: 'dispCd', width: 120, align: 'left', sortable: true, disabled: false,
				formatter: 'listItemText',
				editor: {
					type: 'select',
					options: {
