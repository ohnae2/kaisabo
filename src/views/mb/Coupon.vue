...
onMounted(() => {
	data.grid = new Grid({
		...
		columns: [
			...
			{header: '쿠폰명', name: 'cpnNm', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 쿠폰명
			{header: '쿠폰요금', name: 'cpnPrice', sortable: true, width: 100, align: 'right', disabled: false, editor: 'text'}, // 쿠폰요금
