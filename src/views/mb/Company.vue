...
onMounted(() => {
	data.grid = new Grid({
		...
		columns: [
			...
			{header: '업체구분코드', name: 'cmpDivCd', width: 120, align: 'left', sortable: true, disabled: false,
			...
			{header: '업체명', name: 'cmpNm', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 업체명
			{header: '사업자등록번호', name: 'bizno', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 사업자등록번호
			...
			{header: '위도', name: 'lttd', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 위도
			{header: '경도', name: 'lotd', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 경도
			{header: '사이트URL', name: 'steUrl', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 사이트URL
