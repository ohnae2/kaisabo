...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: '사용자ID', name: 'usrId', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 사용자ID
			{header: '업체ID', name: 'cmpId', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 업체ID
			{header: '그룹ID', name: 'grpId', sortable: true, width: 100, align: 'right', disabled: false, editor: 'text'}, // 그룹ID
			...
			{header: '사용자상태코드', name: 'usrStatCd', width: 120, align: 'left', sortable: true, disabled: false,
