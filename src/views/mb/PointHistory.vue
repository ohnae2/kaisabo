...
onMounted(() => {
	data.grid = new Grid({
		...
		rowHeaders: ['checkbox'],
		columns: [
			{header: '포인트이력번호', name: 'pntHistNo', sortable: true, width: 100, disabled: false, editor: 'text'}, // 포인트이력번호
			...
			{header: '포인트사용코드', name: 'pntUseCd', width: 120, sortable: true, disabled: false,
