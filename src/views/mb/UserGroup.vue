...
const data = reactive({
	grid: {} as Grid,
	required: ['cmpId', 'grpNm', 'linkRef', 'modId', 'modDt', 'regId', 'regDt'],
	totalCount: 0,
	list: [],
	audit: false,
});
...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: '그룹ID', name: 'grpId', sortable: true, width: 100, align: 'right', disabled: false, validation: { dataType: 'number' , required: false }, editor: 'text'}, // 그룹ID
			...
			{header: '그룹명', name: 'grpNm', sortable: true, width: 100, align: 'left', disabled: true, validation: { dataType: 'string' , required: false }, editor: 'text'}, // 그룹명
