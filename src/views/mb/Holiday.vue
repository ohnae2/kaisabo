...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: '휴일', name: 'hld', sortable: true, width: 100, align: 'left', disabled: false, // 휴일
				editor: {
				type: 'datePicker',
					options: {
						format: 'yyyy-MM-dd'
			...
			{header: '휴일명', name: 'hldNm', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 휴일명
			{header: '휴일코드', name: 'hldCd', width: 120, align: 'left', sortable: true, disabled: false,
			...
			{header: '휴일요금', name: 'hldPrice', sortable: true, width: 100, align: 'right', disabled: false, editor: 'text'}, // 휴일요금
