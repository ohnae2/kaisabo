...
onMounted(() => {
	data.grid = new Grid({
		...
		columns: [
			...
			{header: '포인트명', name: 'pntNm', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 포인트명
			{header: '포인트요금', name: 'pntPrice', sortable: true, width: 100, align: 'right', disabled: false, editor: 'text'}, // 포인트요금
