...
const data = reactive({
	grid: {} as Grid,
	required: ['cmpId', 'prodNm', 'psnelCnt', 'maxPsnelCnt', 'm2', 'petPsbYn', 'cnts', 'prir', 'fileNo', 'useYn', 'dispYn', 'note', 'linkRef2', 'linkRef', 'modId', 'modDt', 'regId', 'regDt'],
	totalCount: 0,
	list: [],
	audit: false,
});
...
onMounted(() => {
	data.grid = new Grid({
		...
		columns: [
			...
			{header: '애완동물가능여부', name: 'petPsbYn', sortable: true, width: 100, align: 'left', disabled: true, validation: { dataType: 'string' , required: false }, editor: 'text'}, // 애완동물가능여부
			...
			{header: '전시여부', name: 'dispYn', sortable: true, width: 100, align: 'left', disabled: true, validation: { dataType: 'string' , required: true }, editor: 'text'}, // 전시여부
