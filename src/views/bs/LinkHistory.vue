...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: '연동번호', name: 'linkNo', sortable: true, width: 100, align: 'right', disabled: false, editor: 'text'}, // 연동번호
			{header: '연동명', name: 'linkNm', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 연동명
