...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: '배치번호', name: 'btchNo', sortable: true, width: 100, align: 'right', disabled: false, editor: 'text'}, // 배치번호
			{header: '배치명', name: 'btchNm', sortable: true, width: 100, align: 'left', disabled: false, editor: 'text'}, // 배치명
