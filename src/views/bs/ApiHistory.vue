...
onMounted(() => {
	data.grid = new Grid({
		...
		rowHeaders: ['checkbox'],
		columns: [
			{header: 'API번호', name: 'apiNo', sortable: true, width: 100, disabled: false, editor: 'text'}, // API번호
			{header: 'API명', name: 'apiNm', sortable: true, width: 100, disabled: false, editor: 'text'}, // API명
			...
			{header: 'API참조', name: 'apiRef', sortable: true, width: 100, disabled: false, editor: 'text'}, // API참조
