...
const data = reactive({
	grid: {} as Grid,
	required: ['qnaNo', 'cmpId', 'fileNo', 'mbrNm', 'cnts', 'linkRef', 'modId', 'modDt', 'regId', 'regDt'],
	totalCount: 0,
	list: [],
	audit: false,
});
...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: 'QNA 댓글 번호', name: 'qnaCmmtNo', sortable: true, width: 100, align: 'right', disabled: false, validation: { dataType: 'number' , required: false }, editor: 'text'}, // QNA 댓글 번호
