...
onMounted(() => {
	data.grid = new Grid({
		...
		columns: [
			...
			{header: '회원 전화번호', name: 'mbrTelNo', sortable: true, width: 100, disabled: false, editor: 'text'}, // 회원 전화번호
			{header: '회원 이메일', name: 'mbrEmail', sortable: true, width: 100, disabled: false, editor: 'text'}, // 회원 이메일
			...
			{header: '문자여부', name: 'chrYn', sortable: true, width: 100, disabled: false, editor: 'text'}, // 문자여부
