...
onMounted(() => {
	data.grid = new Grid({
		...
		columns: [
			...
			{header: '문자여부', name: 'chrYn', sortable: true, width: 100, align: 'left', disabled: false, validation: { dataType: 'string' , required: false }, editor: 'text'}, // 문자여부
