...
const data = reactive({
	grid: {} as Grid,
	required: ['cmpId', 'tit', 'cnts', 'fileNo', 'prir', 'useYn', 'strtDt', 'endDt', 'linkRef', 'modId', 'modDt', 'regId', 'regDt'],
	totalCount: 0,
	list: [],
	audit: false,
});
...
onMounted(() => {
	data.grid = new Grid({
		...
		//rowHeaders: ['checkbox'],
		columns: [
			{header: 'FAQ 번호', name: 'faqNo', sortable: true, width: 100, align: 'right', disabled: false, validation: { dataType: 'number' , required: false }, editor: 'text'}, // FAQ 번호
